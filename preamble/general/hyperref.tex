...
\providecommand*{\ManualAuthorPlaintext}{\ManualAuthor}
\providecommand*{\ManualTitlePlaintext}{\ManualTitle}
\providecommand*{\ManualKeywordsPlaintext}{\ManualKeywords}
...
\hypersetup{ % PDF metadata
    pdfauthor   = {\ManualAuthorPlaintext},
    pdftitle    = {\ManualTitlePlaintext},
    pdfsubject  = {\ManualSubject},
    pdfkeywords = {\ManualKeywordsPlaintext},
