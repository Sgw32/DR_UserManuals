...
\begin{figure}[!ht]
    \fcapside[\FBwidth]{%
        ...
        \caption[\TeXtured{} Template File Structure]{%
            ...
            The main file is \path{DR_DRNext_User_Manual_mk1_mk2.tex}.
            ...
            All of the \TeXtured{} tweaks and settings located in files under \path{preamble/...} directories are loaded by the \path{preamble/main.tex} file, which is itself \fakemacro{\input}ed in the \path{DR_DRNext_User_Manual_mk1_mk2.tex} file.
        ...
        \begin{tikzpicture}[dirtree]
            ...
            child { node {DR\_DRNext\_User\_Manual\_mk1\_mk2.tex}}
            child { node {LICENSE}}
...
\begin{itemize}
    ...
    \item \textsf{Content.} Write the content of the document in the \path{chapters/} directory.
          If you need more chapters, just create a new file, and \macro{\include} it in the \path{DR_DRNext_User_Manual_mk1_mk2.tex} file at appropriate place.
...
\begin{remark}[Toggles]
    There are a couple of \emph{toggles} in the \path{DR_DRNext_User_Manual_mk1_mk2.tex} file that can be used to customize style/layout/creation of the document:
    \begin{itemize}
...
\begin{remark}[MFF CUNI Template Compatibility]
    ...
    \end{itemize}
    This is done by uncommenting the relevant lines in the main \path{DR_DRNext_User_Manual_mk1_mk2.tex} file.
