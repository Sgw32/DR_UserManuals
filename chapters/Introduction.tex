...
Readers who are preparing to install the instrument cluster for the first time should start with \Cref{ch:Design,ch:Usage}, while experienced users will find configuration references in \Cref{ch:Features,ch:Tips}.
