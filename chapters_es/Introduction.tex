...
Este manual operativo cubre los cuadros de instrumentos digitales \ReplicaGenOne{} y \ReplicaNextLong{} para los vehículos Volkswagen Golf~II/III, Jetta~II, Vento y Scirocco~II. Resume las variantes de hardware, describe sus funciones y explica cómo instalar, configurar, operar, almacenar y mantener los tableros. Las recomendaciones están dirigidas a propietarios de vehículos, electricistas automotrices y talleres que realizan la instalación del producto. La edición ampliada incorpora las configuraciones de cuadro para Golf Mk3 y Volkswagen Vento, que comparten el cableado y la calibración con las plataformas anteriores.
